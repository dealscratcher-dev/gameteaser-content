...
3. If it creates a new site, go to **Domain settings** and set 
...
| Check | URL |
|-------|-----|
| ads.txt | https://thegamebit.online/ads.txt |
...
**https://thegamebit.online/** — copy button is on the site.
